...
(1, 1, 'Understanding Anxiety', 'Common Symptoms and Causes', 'Anxiety disorders are the most common mental health concern in the United States. Learn about the symptoms, causes, and treatments for anxiety. Anxiety can manifest in various ways, including physical symptoms such as increased heart rate, sweating, and shaking, as well as mental symptoms like excessive worrying and fear. It is important to recognize these signs early and seek appropriate treatment, which may include therapy, medication, and self-care practices such as mindfulness and exercise.', 10, CURRENT_TIMESTAMP, 'General Discussion'),
(2, 1, 'Coping with Stress', 'Effective Strategies', 'Stress is a part of life, but there are effective strategies to cope with it. Learn about different ways to manage and reduce stress. Chronic stress can have significant negative effects on your mental and physical health, leading to issues such as anxiety, depression, and heart disease. Effective stress management techniques include practicing relaxation exercises, maintaining a healthy lifestyle, and seeking support from friends, family, or mental health professionals.', 7, CURRENT_TIMESTAMP, 'General Discussion'),
(3, 1, 'Dealing with Depression', 'How to Recognize and Cope', 'Depression is more than just feeling sad. It is a serious condition that affects your physical and mental health. Explore ways to recognize and cope with depression. Depression can lead to persistent feelings of sadness, loss of interest in activities, and changes in appetite and sleep patterns. Coping with depression often involves a combination of therapy, medication, lifestyle changes, and support from loved ones. It is crucial to seek help early and develop a personalized treatment plan.', 5, CURRENT_TIMESTAMP, 'Depression and Sadness'),
(4, 1, 'My Journey with Depression', 'Personal Story of Overcoming', 'Sharing my personal journey of dealing with depression and the steps I took to overcome it. Throughout my experience with depression, I faced numerous challenges, including feelings of hopelessness and isolation. However, with the support of my family and friends, and by seeking professional help, I was able to develop coping strategies that worked for me. These included therapy, medication, and incorporating positive habits such as regular exercise and healthy eating into my daily routine.', 12, CURRENT_TIMESTAMP, 'Depression and Sadness'),
(5, 1, 'The Importance of Mental Health', 'Why Mental Health Matters', 'Mental health is just as important as physical health. Learn about the importance of mental well-being and how to maintain it. Maintaining good mental health involves managing stress, recognizing and addressing mental health issues early, and adopting healthy lifestyle practices. This can include regular physical activity, balanced nutrition, adequate sleep, and fostering positive relationships. Prioritizing mental health can lead to improved overall well-being and a higher quality of life.', 8, CURRENT_TIMESTAMP, 'Education'),
(6, 1, 'Understanding Emotions', 'Educational Insights', 'Understanding and managing emotions is crucial for mental health. Learn about different emotions and how to deal with them. Emotions are complex and can affect our thoughts, behaviors, and overall mental health. By learning to recognize and understand our emotions, we can develop healthier ways of coping with difficult feelings. This can involve techniques such as mindfulness, emotional regulation strategies, and seeking support from mental health professionals when needed.', 9, CURRENT_TIMESTAMP, 'Education'),
(7, 1, 'Mindfulness Techniques', 'Practices for Stress Relief', 'Mindfulness involves paying full attention to what is going on in the present moment. Discover various mindfulness techniques to help reduce stress. Mindfulness can help reduce stress by encouraging us to focus on the present moment and let go of negative thoughts and worries. Techniques such as deep breathing, meditation, and mindful movement can promote relaxation and improve mental clarity. Practicing mindfulness regularly can lead to long-term benefits for mental health.', 15, CURRENT_TIMESTAMP, 'Mindfulness and Relaxation'),
...
(1, 1, 'John Doe', 'Great article on understanding anxiety. Very informative!', 3, CURRENT_TIMESTAMP),
(2, 1, 'Jane Doe', 'I found the symptoms list particularly helpful.', 2, CURRENT_TIMESTAMP),
(3, 2, 'Alice', 'The strategies mentioned here have really helped me manage stress better.', 5, CURRENT_TIMESTAMP),
(4, 3, 'Bob', 'Depression is tough, but knowing these coping methods makes it manageable.', 1, CURRENT_TIMESTAMP),
(5, 4, 'Charlie', 'Thanks for sharing your personal story. It’s very inspiring!', 4, CURRENT_TIMESTAMP),
(6, 4, 'Eve', 'I appreciate the honesty in your journey. It gives hope to others.', 6, CURRENT_TIMESTAMP),
(7, 5, 'Frank', 'Mental health is indeed important. Thanks for highlighting this.', 7, CURRENT_TIMESTAMP),
(8, 6, 'Grace', 'Understanding emotions is key to better mental health. Good read!', 5, CURRENT_TIMESTAMP),
(9, 7, 'Heidi', 'Mindfulness has been a game changer for my stress levels. Highly recommend it.', 3, CURRENT_TIMESTAMP),
(10, 8, 'Ivan', 'Breathing exercises are so effective. This article is a must-read.', 9, CURRENT_TIMESTAMP),
(11, 9, 'Judy', 'Finding the right therapist can be daunting but this guide makes it easier.', 2, CURRENT_TIMESTAMP),
(12, 10, 'Mallory', 'Good overview of the different types of therapy available.', 4, CURRENT_TIMESTAMP),
(13, 11, 'Niaj', 'Early signs in children are crucial to recognize. Great article.', 5, CURRENT_TIMESTAMP),
(14, 12, 'Olivia', 'Supportive tips for parents. Very useful!', 6, CURRENT_TIMESTAMP),
(15, 13, 'Peggy', 'Exercise has improved my mental health significantly.', 1, CURRENT_TIMESTAMP),
(16, 14, 'Quinn', 'Healthy eating can indeed impact your mental state. Good tips.', 3, CURRENT_TIMESTAMP),
(17, 15, 'Rick', 'Sleep is often overlooked. Thanks for the insights.', 4, CURRENT_TIMESTAMP),
(18, 16, 'Steve', 'A consistent sleep routine has helped me immensely.', 2, CURRENT_TIMESTAMP),
(19, 17, 'Tina', 'Making new friends is tough, but these tips are helpful.', 6, CURRENT_TIMESTAMP),
(20, 18, 'Uma', 'Conflict resolution skills are crucial for healthy relationships.', 5, CURRENT_TIMESTAMP),
(21, 19, 'Vince', 'Bullying can be devastating. These strategies are very helpful.', 4, CURRENT_TIMESTAMP),
(22, 20, 'Wendy', 'Standing up to peer pressure is important. Good advice here.', 7, CURRENT_TIMESTAMP),
(23, 21, 'Xander', 'Art as therapy is a wonderful concept. Very therapeutic.', 5, CURRENT_TIMESTAMP),
(24, 22, 'Yara', 'Journaling has helped me process my emotions. Highly recommend.', 3, CURRENT_TIMESTAMP),
(25, 23, 'Zara', 'Great to have a place to ask professionals. Very helpful.', 2, CURRENT_TIMESTAMP),
(26, 24, 'Alex', 'This Q&A section is very informative. Thanks for the answers.', 4, CURRENT_TIMESTAMP),
(27, 25, 'Blake', 'Reading success stories is very motivating. Thanks for sharing.', 5, CURRENT_TIMESTAMP),
(28, 26, 'Cathy', 'Positivity can be infectious. Great platform to share joy.', 3, CURRENT_TIMESTAMP),
(29, 27, 'Dan', 'Coping strategies shared here are practical and useful.', 6, CURRENT_TIMESTAMP),
(30, 28, 'Elle', 'Building resilience is crucial. Thanks for these tips.', 4, CURRENT_TIMESTAMP),
(31, 29, 'Fred', 'Access to these mental health resources is invaluable.', 2, CURRENT_TIMESTAMP),
(32, 30, 'George', 'Educational videos are a great resource. Very enlightening.', 3, CURRENT_TIMESTAMP),
(33, 31, 'Hannah', 'Balancing gaming and mental health is important. Good insights.', 5, CURRENT_TIMESTAMP),
(34, 32, 'Ivy', 'Hobbies can definitely help with relaxation. Great suggestions.', 4, CURRENT_TIMESTAMP);
-- Likes
